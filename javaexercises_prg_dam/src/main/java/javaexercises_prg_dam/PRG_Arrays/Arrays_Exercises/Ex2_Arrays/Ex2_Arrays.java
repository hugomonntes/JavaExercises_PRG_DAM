package javaexercises_prg_dam.PRG_Arrays.Arrays_Exercises.Ex2_Arrays;
...
public class Ex2_Arrays {
    ...
    public static boolean intercambiarDatos(char[][] tabla, int indice1, int indice2, int indice3, int indice4){
        if (indice1 >= tabla.length || indice3 >= tabla.length || indice1 < 0 || indice3 < 0 || indice2 >= tabla.length || indice4 >= tabla.length|| indice2 < 0 || indice4 < 0){//TODO  3 y 4 y comparar 2 con cols
        return false;
        } else {
